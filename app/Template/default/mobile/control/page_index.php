<?php if(!defined('APP')) die('...');
	...
	(
		$limit		= $config['mobile_manset_main'],
		$type		= '1',
		$template	= 'none',
		$cat		= 'none',
		$order		= 'order',
	...
	(
		$limit		= $config['mobile_manset_sur'],
		$type		= '2',
		$template	= 'none',
		$cat		= 'none',
		$order		= 'order',
	...
	(
		$limit		= $config['mobile_manset_sondakika'],
		$type		= '3',
		$template	= 'none',
		$cat		= 'none',
		$order		= 'order',
	...
	(
		$limit		= $config['mobile_block_galeri'],
		$type		= 'none',
		$template	= '1',
		$cat		= 'none',
		$order		= 'time',
	...
	if(RC_InternalVideo == 1)
	{
		...
		(
			$limit		= $config['mobile_block_video'],
			$type		= 'none',
			$template	= '4',
			$cat		= 'none',
			$order		= 'time',
	...
	(
		$limit		= $config['mobile_manset_alt_bir'],
		$type		= '4',
		$template	= 'none',
		$cat		= 'none',
		$order		= 'order',
	...
	(
		$limit		= $config['mobile_manset_alt_iki'],
		$type		= '5',
		$template	= 'none',
		$cat		= 'none',
		$order		= 'order',
	...
	(
		$limit		= $config['mobile_block_roportaj'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '114',
		$order		= 'time',
	...
	(
		$limit		= $config['mobile_block_gundem'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '100',
		$order		= 'time',
	...
	(
		$limit		= $config['mobile_block_spor'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '101',
		$order		= 'time',
	...
	(
		$limit		= $config['mobile_block_magazin'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '112',
		$order		= 'time',
	...
	(
		$limit		= $config['mobile_block_dunya'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '104',
		$order		= 'time',
	...
	(
		$limit		= $config['mobile_block_teknoloji'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '105',
		$order		= 'time',
	...
	(
		$limit		= $config['mobile_block_yasam'],
		$type		= 'none',
		$template	= '0,2',
		$cat		= '102',
		$order		= 'time',
