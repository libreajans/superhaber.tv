<?php if(!defined('APP')) die('...');
	...
	if($do == 'add')
	{
		if($_REQUEST['type'] == 'sondakika')
		{
			$_id = $_content->content_add($_SESSION[SES]['user_id'], $tip = 'sondakika');
		}
		elseif($_REQUEST['type'] == 'flash')
		{
			$_id = $_content->content_add($_SESSION[SES]['user_id'], $tip = 'flash');
		}
		elseif($_REQUEST['type'] == 'sehit')
		{
			$_id = $_content->content_add($_SESSION[SES]['user_id'], $tip = 'sehit');
		}
		elseif($_REQUEST['type'] == 'deprem')
		{
			$_id = $_content->content_add($_SESSION[SES]['user_id'], $tip = 'deprem');
		}
		else
		{
			$_id = $_content->content_add($_SESSION[SES]['user_id'], $tip = 'none');
		}
