<?php if(!defined('APP')) die('...') ?>
	...
	<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
		...
		<input type="hidden" name="content_tags" value="yönlendirme"/>
		<input type="hidden" name="content_desc" value="yönlendirme"/>
		<input type="hidden" name="content_title_seo" value="yönlendirme"/>
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="input-group col-md-10 clearMe">
					<span class="input-group-addon"><i class="ion ion-alert"></i> Yönlendirme URL</span>
					<textarea required class="force_input form-control" id="content_redirect" name="content_redirect"><?=$content_redirect?></textarea>
				</div>
