<?php if(!defined('APP')) die('...');
	...
	//kaynak: https://github.com/carlosbuenosvinos/opcache-dashboard
	...
	else
	{
		...
		?>
			<style>
				...
				.content-app th, .tab-app:nth-child(3) td {
					text-align: left;
				}
				...
				[type=radio]:checked ~ label ~ .content-app {
					z-index: 1;
				}
